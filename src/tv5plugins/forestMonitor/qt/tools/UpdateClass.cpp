...
bool te::qt::plugins::tv5plugins::UpdateClass::panMousePressEvent(QMouseEvent* e)
{
...
bool te::qt::plugins::tv5plugins::UpdateClass::panMouseMoveEvent(QMouseEvent* e)
{
  if (!m_panStarted)
    return false;
...
bool te::qt::plugins::tv5plugins::UpdateClass::panMouseReleaseEvent(QMouseEvent* e)
{
  m_panStarted = false;
