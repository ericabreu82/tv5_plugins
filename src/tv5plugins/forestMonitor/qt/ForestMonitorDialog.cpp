...
/*!
  \file terralib/qt/plugins/thirdParty/forestMonitor/qt/ForestMonitorDialog.cpp
...
te::qt::plugins::tv5plugins::ForestMonitorDialog::ForestMonitorDialog(QWidget* parent, Qt::WindowFlags f)
  : QDialog(parent, f),
...
te::qt::plugins::tv5plugins::ForestMonitorDialog::~ForestMonitorDialog()
{

}

void te::qt::plugins::tv5plugins::ForestMonitorDialog::setLayerList(std::list<te::map::AbstractLayerPtr> list)
{
  //clear combos
...
te::map::AbstractLayerPtr te::qt::plugins::tv5plugins::ForestMonitorDialog::getOutputLayer()
{
  return m_outputLayer;
}

void te::qt::plugins::tv5plugins::ForestMonitorDialog::onOkPushButtonClicked()
{  
  ...
  try
  {
    te::qt::plugins::tv5plugins::ForestMonitorService fms;
...
void te::qt::plugins::tv5plugins::ForestMonitorDialog::onTargetDatasourceToolButtonPressed()
{
...
void te::qt::plugins::tv5plugins::ForestMonitorDialog::onTargetFileToolButtonPressed()
{
  m_ui->m_newLayerNameLineEdit->clear();
